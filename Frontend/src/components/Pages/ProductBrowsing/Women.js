...
class Women extends Component {
  ...
  componentDidMount() {
    axios.get(`${process.env.REACT_APP_BACKEND_URL}/cosmetic/women`, this.state)
      .then((response) => {
      ...
      <>
        <div className="container sCosmetics">
          ...
          <div className="row cBand">
            <NavDropdown title="Cosmetic Gender" id="collasible-nav-dropdown" className="col-sm-2 NavDropdown">
